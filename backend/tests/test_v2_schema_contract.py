...
EXPECTED_COLUMNS = {
    ...
    "treatment_plan_versions": ("id", "patient_id", "source_system", "source_record_id", "version_ordinal", "plan_date", "signature_date", "admission_date", "source_next_review_due", "normalized_snapshot_encrypted", "content_sha256", "evidence_sha256", "imported_at", "supersedes_version_id"),
    ...
    "sync_checkpoints": ("id", "job_id", "endpoint_key", "page_number", "cursor_hash", "response_shape_sha256", "committed_at"),
...
EXPECTED_FOREIGN_KEYS = {
    ...
    "treatment_plan_versions": {("patient_id", "patients"), ("supersedes_version_id", "treatment_plan_versions")},
    "treatment_review_versions": {("patient_id", "patients"), ("supersedes_version_id", "treatment_review_versions")},
    "diagnosis_snapshots": {("plan_version_id", "treatment_plan_versions"), ("review_version_id", "treatment_review_versions")},
    ...
    "evaluation_runs": {("plan_version_id", "treatment_plan_versions")},
...
EXPECTED_UNIQUE_KEYS = {
    ...
    "patients": {("facility_id", "source_system", "canonical_client_id")},
