...
class AppSetting(Base):
    ...
    api_client_secret: Mapped[str] = mapped_column(String(1024), default='')
    ...
    alleva_api_base_url: Mapped[str] = mapped_column(String(255), default='https://api.allevasoft.com')
    alleva_openapi_url: Mapped[str] = mapped_column(String(500), default='https://api.allevasoft.com/swagger/v1/swagger.json')
    ...
    alleva_treatment_plan_sync_on_startup: Mapped[bool] = mapped_column(Boolean, default=False)
    ...
    alleva_treatment_plan_sync_last_status: Mapped[str] = mapped_column(String(40), default='')
    alleva_treatment_plan_sync_last_message: Mapped[str] = mapped_column(Text, default='')
    alleva_treatment_plan_sync_last_success_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=True)
    alleva_treatment_plan_sync_last_failure_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=True)
...
class EmrEndpointProfile(Base):
    ...
    adapter_key: Mapped[str] = mapped_column(String(120), default='alleva-rest-api')
...
class TreatmentPlanClient(Base):
    ...
    source_note_set_id: Mapped[int] = mapped_column(ForeignKey('patient_note_sets.id'), nullable=True, index=True)
    alleva_lead_id: Mapped[str] = mapped_column(String(120), default='')
    alleva_client_id: Mapped[str] = mapped_column(String(120), default='')
    alleva_unique_id: Mapped[str] = mapped_column(String(120), default='')
    alleva_mrn: Mapped[str] = mapped_column(String(120), default='')
    alleva_source_id: Mapped[str] = mapped_column(String(120), default='')
    id_join_confidence: Mapped[str] = mapped_column(String(40), default='unknown')
    id_join_warnings: Mapped[str] = mapped_column(Text, default='')
    data_quality_warnings: Mapped[str] = mapped_column(Text, default='')
    discharge_conflict: Mapped[bool] = mapped_column(Boolean, default=False)
    current_plan_record_id: Mapped[int | None] = mapped_column(ForeignKey('treatment_plan_records.id'), nullable=True)
    ...
    treatment_plans: Mapped[list['TreatmentPlanRecord']] = relationship(cascade='all, delete-orphan', back_populates='client', foreign_keys='TreatmentPlanRecord.client_id')
    current_plan_record: Mapped['TreatmentPlanRecord | None'] = relationship(foreign_keys=[current_plan_record_id], post_update=True)
...
class TreatmentPlanRecord(Base):
    ...
    has_guardian_signature: Mapped[bool] = mapped_column(Boolean, default=False)
    guardian_signature_date: Mapped[str] = mapped_column(String(40), default='')
    alleva_is_active: Mapped[bool] = mapped_column(Boolean, default=True)
    alleva_is_complete: Mapped[bool] = mapped_column(Boolean, default=False)
    alleva_is_initial_tp: Mapped[bool] = mapped_column(Boolean, default=False)
    alleva_start_date: Mapped[str] = mapped_column(String(40), default='')
    alleva_end_date: Mapped[str] = mapped_column(String(40), default='')
    alleva_last_modified: Mapped[str] = mapped_column(String(40), default='')
