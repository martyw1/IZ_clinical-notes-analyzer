...
from app.v2.migrations.schema_patient_snapshot import PATIENT_SNAPSHOT_STATEMENTS
...
MIGRATIONS = (
    ...
    _migration(9, "persist_encrypted_patient_source_snapshots", PATIENT_SNAPSHOT_STATEMENTS),
)
