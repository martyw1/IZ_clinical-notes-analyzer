...
CURRENT_COLUMNS = {
    ...
    "treatment_plan_versions": {"id", "patient_id", "source_system", "source_record_id", "version_ordinal", "normalized_snapshot_encrypted", "content_sha256", "evidence_sha256", "imported_at"},
    ...
    "sync_checkpoints": {"id", "job_id", "endpoint_key", "page_number", "cursor_hash"},
