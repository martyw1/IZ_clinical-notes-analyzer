...
function Invoke-IdentityAndVersionTests {
    ...
    $production = [pscustomobject]@{version='1.0.0';build='2026.09.21.2';installer_revision=1;release_channel='stable-local-desktop'}
    ...
    $stable=New-IzReleaseIdentity -Version '1.0.0' -Build '2026.09.21.2' -InstallerRevision 1 -PayloadIdentity ('f'*64)
    ...
    $stableCompatibility=[pscustomobject]@{source_version_minimum='1.0.0';source_version_maximum='2.0.0-beta.4';source_build_minimum='2026.09.03.1';source_build_maximum='2026.09.21.2';source_schema_minimum=12;source_schema_maximum=12}
