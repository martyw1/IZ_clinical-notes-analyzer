...
- Backend: `backend/app/` FastAPI service with auth/RBAC, settings, audit logging, encrypted uploads, deterministic rules, API connectivity harness, EMR/FHIR readiness boundary, and version/readiness endpoints.
