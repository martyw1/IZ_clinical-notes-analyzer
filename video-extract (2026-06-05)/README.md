...
- React/CSS reference code using synthetic data only.
...
- `frontend-reference/TreatmentPlanTimelinessVideoMockup.tsx`: React reference component.
- `frontend-reference/treatment-plan-timeliness-video.css`: CSS reference styling.
- `frontend-reference/mockup-data.json`: synthetic sample payload for the mockup.
