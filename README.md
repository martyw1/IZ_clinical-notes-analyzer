...
Current app version: `1.3.0` / build `2026.06.16.1`.
...
## Current Version 1.3.0 State

Version 1.3.0 is the current local-desktop patch. It includes:
...
A release folder is created by `scripts\build-windows-installer.ps1`. For Version 1.3.0 it writes:
...
1. Open `dist\windows-release\IZ-Clinical-Notes-Analyzer-v1.3.0`.
