...
1. Expand YAML rules for Marleigh's exact timeline requirements.
2. Add or extend models for treatment plan timeline records and LOC history.
3. Add dashboard status APIs and UI.
4. Implement missing-data matrix.
5. Implement override RBAC and audit behavior.
