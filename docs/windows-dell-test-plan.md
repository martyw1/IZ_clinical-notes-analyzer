...
1. Sign in as `admin`.
2. Confirm the footer shows version `0.5.0` after the final version bump.
3. Open `Treatment plans`.
4. Confirm the dashboard loads and the LOC-change window is visibly unvalidated if not confirmed.
5. Open `Settings`.
...
- Screenshot of the app footer showing version `0.5.0`.
