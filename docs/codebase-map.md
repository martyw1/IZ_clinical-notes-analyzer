# Codebase Map - Current Version 1.4.3

Date: 2026-06-17

Branch: `main`

Version: `1.4.3` / build `2026.06.19.1`

## Scope

This file is the current orientation map for the remote repository. Older S0/S1/S2/S3/S4/S5 notes, PRDs, walkthroughs, and external analyses remain historical references, but this document reflects the active Version 1.4.3 app shape.
...
| `scripts/startup-windows.ps1` | Deprecated legacy | Older Docker/PostgreSQL-oriented Windows launcher. Do not use for Version 1.4.3 local desktop startup. |
